...
$pass= $_POST['pass'];
     ...
     $sql = "SELECT * FROM dealer_mast_tbl WHERE did='$uid' AND pass='$cpass'";
         $stmt = $conn -> query($sql);
		  $count = mysqli_num_rows($stmt);
if($count==1){
$sql_c = "UPDATE dealer_mast_tbl SET pass='$pass' WHERE did='$uid'";
...
<body>
   ...
   <button><a href="dealer_index.php">Home</a></button>
